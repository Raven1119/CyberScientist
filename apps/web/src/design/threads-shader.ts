/* RB-01 Threads: frozen V9 reference.html shader; formulas unchanged.
 * React Bits copyright David Haz. See public/legal/research-interface-notices.txt.
 * CyberScientist change: exported constants for the application WebGL host. */
export const VERTEX100 = `attribute vec2 position; void main(){gl_Position=vec4(position,0.,1.);}`;
...
void mainImage(out vec4 fragColor,in vec2 fragCoord){
 vec2 uv=fragCoord/iResolution.xy;float line_strength=1.0;
